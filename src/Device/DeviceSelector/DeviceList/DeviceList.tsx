...
const DeviceList: FC<Props> = ({
    ...
    return (
        ...
        >
            <div className="device-list-overlay-relay tw-flex tw-flex-col">
            ...
            <div>
                <p className="tw-m-0 tw-bg-gray-200 tw-px-6 tw-py-2 tw-text-xs/3 tw-uppercase">
                    Virtual Devices
                </p>
                {virtualDevices.map(virtualDevice => (
                    <VirtualDevice
                        virtualDevice={virtualDevice}
                        onSelect={() => doSelectVirtualDevice(virtualDevice)}
                        key={virtualDevice}
                    />
                ))}
            </div>
