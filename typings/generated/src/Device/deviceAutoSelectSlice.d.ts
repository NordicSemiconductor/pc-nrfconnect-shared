...
export declare const reducer: import("redux").Reducer<DeviceAutoSelectState, import("redux").AnyAction>, setAutoReconnectTimeoutID: import("@reduxjs/toolkit").ActionCreatorWithPayload<NodeJS.Timeout, string>, clearAutoReconnectTimeoutID: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>, setAutoSelectDevice: import("@reduxjs/toolkit").ActionCreatorWithPayload<Device, string>, setDisconnectedTime: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, string>, setGlobalAutoReselect: import("@reduxjs/toolkit").ActionCreatorWithPayload<boolean, string>, setForceAutoReselect: import("@reduxjs/toolkit").ActionCreatorWithPayload<ForceAutoReselect, string>, clearAutoReselect: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>;
