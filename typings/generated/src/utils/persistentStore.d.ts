...
export declare const persistSerialPort: (serialNumber: string, appName: string, serialPortOptions: SerialPortOpenOptions<AutoDetectTypes>, vComIndex: number) => void;
export declare const getPersistedSerialPort: (serialNumber: string, appName: string) => SerialSettings | undefined;
