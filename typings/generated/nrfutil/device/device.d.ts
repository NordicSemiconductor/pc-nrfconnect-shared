...
declare const _default: {
    ...
    setMcuState: (device: import("./common").NrfutilDeviceWithSerialnumber, state: import("./setMcuState").McuState, onProgress?: ((progress: import("../sandboxTypes").Progress) => void) | undefined, controller?: AbortController | undefined) => Promise<NonNullable<void>>;
    ...
    firmwareRead: (device: import("./common").NrfutilDeviceWithSerialnumber, core?: import("./common").DeviceCore | undefined, onProgress?: ((progress: import("../sandboxTypes").Progress) => void) | undefined, controller?: AbortController | undefined) => Promise<Buffer>;
